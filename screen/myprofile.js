    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.detail}>
                ...
                <Image
                    style={{ width: 120, height: 180, borderRadius: 10, marginTop: 25 }}
                    source={require('../assets/rafi.jpg')}
                />
                <Text style={styles.teks}>Rafi Ramadhan Pratama</Text>
                <Text style={styles.teks}>120140079</Text>
