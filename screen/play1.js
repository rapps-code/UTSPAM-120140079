...
const play1 = ({ navigation }) => {
    ...
    async function playSound() {
        ...
        const { sound } = await Audio.Sound.createAsync(require('../assets/reminder.mp3')
        );
        setSound(sound);
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.detail}>
                ...
                />
                <Text style={styles.judulLagu}>Reminder</Text>
                <Text style={styles.pencipta}>The Weeknd</Text>
            </View>
